...
import 'package:movies/widgets/search_movie_card.dart';
          ...
          // The search area heresss
            title: Container(
              ...
              child: Center(
                child: TextField(
                  onChanged: (text) {
                        context.read<SearchMoviesCubit>().loadSearchMovies(
                            context.read<AuthenticationCubit>(), text);
                  },
                    ...
                    return ListView(
                        children: context
                          ...
                          return SearchMovieCard(
                              genre: '',
                              title: movie['title'] ?? '',
                              image: movie['poster_path']!=null?'https://image.tmdb.org/t/p/w200' +
                          movie['poster_path']:'',
